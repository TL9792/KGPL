...
parser.add_argument("--logdir", default="pretrain", type=str, help="directory to save the tensorboard logs")
parser.add_argument("--fold", default=1, type=int, required=False,help="data fold") 
parser.add_argument("--pretrained_model_name", default="model.pt", type=str, help="pretrained model name")  
parser.add_argument("--data_dir", default="/dataset/brats2021/", type=str, required=False,help="dataset directory")  
...
parser.add_argument("--batch_size", default=2, type=int, required=False, help="number of batch size") 
...
parser.add_argument("--noamp", action="store_true", default=False, required=False,help="do NOT use amp for training") 
parser.add_argument("--val_every", default=1, type=int, required=False, help="validation frequency") 
parser.add_argument("--distributed", default=True, required=False, action="store_true", help="start distributed training") 
